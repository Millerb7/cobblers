...
| Rift rim post | **fragile, and currently not visible at all:** 0 of 272 points over bare terrain since the Rift sculpt raised the rim between the post and its leg, 2026-09-23 (visibility:rift_rim_stop_from_its_leg_terrain) | **not visible:** 0 of 272 points since Victory Road ends at the League on the trunk head, 2026-09-21 (visibility:rift_rim_stop_from_its_leg_canopy); needs a tall marker |
