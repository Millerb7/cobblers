...
- **Quest data:** 16 dialogue conversations and 3 quests exist as source data; 1 (the Route 1 thirsty stranger, 44 nodes) ran on the disposable world (EXP-022), the 13 conversations covering all ten mainline beats compile but are not runtime-tested, and 0 are placed in the live world.
