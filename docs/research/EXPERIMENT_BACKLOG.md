...
| EXP-001 F4 curated route | active; structure proof passed | authored encounter table plus a memorable optional place | controlled 10–20-species Pallet coast and runtime-placed Relic Island | MIT Pallet donor placed and survived restart; client art/sightline and spawn proof remain; final reward waits for EXP-006/007 |
