...
| EXP-009 Automated hex world | partial | deterministic 2×2 terrain and scale proof | source masks → exported/booted world → client mount test | sources and adapter ready; WorldPainter export/boot blocked by missing local tool |
