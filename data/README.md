...
| `routes.json` | Terrain-derived critical-route polylines, elevation/crossing evidence, geography intervals, mandatory waypoints and 1,324 spawn boxes | **derived candidate**, schema `cobblers.routes/1`; generated by `tools/build_routes.py` on the canonical heightmap, 0 sub-region holes |
