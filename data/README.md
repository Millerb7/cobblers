...
| `placements.json` | Structure instances placed by command, and each settlement's composition (roads, waystone, spawn) | **draft**, schema `cobblers.placements/1`: the hometown's nine buildings, placed in the live world 2026-09-15 by `tools/place_town.py` |
