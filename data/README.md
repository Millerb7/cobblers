...
| `towns.json` | Town placements: hometown, eight gym towns, the League. Centre, footprint square and class, sub-region, nearby landmarks, approach leg with water crossings, route role | **proposed** 2026-09-14, schema `cobblers.towns/1`; nothing built. Validated: ids, orders, footprint within the border, every progression waystone town present. `docs/world-building/TOWNS.md` |
